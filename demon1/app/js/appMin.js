...
(function(global, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define('BackboneMVC',['backbone', 'underscore', 'jquery'], function (backbone, underscore, jquery) {
...
define('ctrl/ct0',['require','BackboneMVC','jquery','underscore'],function (require) {
...
define('model/model',['require','jquery','underscore'],function (require) {
    $ = require("jquery")
    _ = require("underscore")
    var pri = {
        name: 1,
...
;
define('model/model2',['require','exports','module','jquery','underscore'],function (require, module, exports) {
    $ = require("jquery")
    _ = require("underscore")
...
define('text!templete/view1.html',[],function () { return '\n<div style="display:  inline-block; margin: 0px 5px" ><%= parm %> ok now </div>';});

define('view/view2',['require','jquery','underscore','text!templete/view1.html'],function (require) {
    $ = require("jquery")
    _ = require("underscore")
...
;
define('ctrl/ct1',['require','BackboneMVC','jquery','underscore'],function (require) {
    BackboneMVC = require("BackboneMVC")
    $ = require("jquery")
    _ = require("underscore")
...
define('ctrl/ct2',['require','BackboneMVC','jquery','underscore','model/model','model/model2','view/view2'],function (require) {
    BackboneMVC = require("BackboneMVC")
    $ = require("jquery")
    _ = require("underscore")
